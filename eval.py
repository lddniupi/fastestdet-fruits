...
if __name__ == '__main__':
    ...
    parser.add_argument('--yaml', type=str, default="./data/firuts.yaml", help='.yaml config')
    parser.add_argument('--weight', type=str, default='./checkpoint/weight_AP05_0.980960_70-epoch.pth', help='.weight config')
